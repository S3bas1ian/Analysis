...
void each_detector()
{
    ...
    c1->SaveAs((std::string("2d_hist_detectors_") + std::to_string(energy_min) + std::string(".png")).c_str());
    ...
    c2->SaveAs((std::string("total_detectors_") + std::to_string(energy_min) + std::string(".png")).c_str());
    ...
    c3->SaveAs((std::string("particle_overview_") + std::to_string(energy_min) + std::string(".png")).c_str());
}