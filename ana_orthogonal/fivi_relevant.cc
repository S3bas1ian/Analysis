...
void fivi_relevant()
{
    ...
    c1->SaveAs("2d_hist_detectors_fivi_relevant_" + std::string(std::to_string(energy_min)) + ".png");
    ...
    c2->SaveAs("total_detectors_fivi_relevant_" + std::string(std::to_string(energy_min)) + ".png");
    ...
    c3->SaveAs("particle_overview_fivi_relevant_" + std::string(std::to_string(energy_min)) + ".png");
}