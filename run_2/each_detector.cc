...
void each_detector(std::string path, std::string particle, Double_t energy_min, bool draw)
{
    ...
    // int vector for total amount of particles per side
    std::vector<int> total_hits;
    total_hits.resize(8); // 8 detectors
    ...
    while (i < size) // loop through all events
    {
        ...
        while (sameEvent && i < size) // loop through one full event, increase i while doing so
        {
            ...
            if (event_number == currEvent)
            {
                ...
                if (edep > energy_min && (particle.compare(std::string(particle_name)) == 0 || particle.compare("all") == 0))
                {
                    ...
                    if (std::string(particle_name).compare("proton") == 0 || std::string(particle_name).compare("deuteron") == 0 || std::string(particle_name).compare("triton") == 0 || std::string(particle_name).compare("e-") == 0)
                    {
        ...
        if (event_size > 0)
        {
            ...
            if (event_size_det_1 > 0)
            {
                ...
                if (front_size_det_1 > 0)
                {
                    total_hits[0]++;
                }

                if (back_size_det_1 > 0)
                {
                    total_hits[1]++;
                }
            }
            else if (event_size_det_2 > 0)
            {
                ...
                if (front_size_det_2 > 0)
                {
                    total_hits[2]++;
                }

                if (back_size_det_2 > 0)
                {
                    total_hits[3]++;
                }
            }
            else if (event_size_det_3 > 0)
            {
                ...
                if (front_size_det_3 > 0)
                {
                    total_hits[4]++;
                }

                if (back_size_det_3 > 0)
                {
                    total_hits[5]++;
                }
            }
            else if (event_size_det_4 > 0)
            {
                ...
                if (front_size_det_4 > 0)
                {
                    total_hits[6]++;
                }

                if (back_size_det_4 > 0)
                {
                    total_hits[7]++;
                }
            }
    ...
    if (draw)
    {
        ...
        h3_2d->GetYaxis()->SetNdivisions(5, 2, false);
        h3_2d->GetXaxis()->SetNdivisions(10, 0, false);
        h3_2d->SetTitleSize(70, "xyz");
        h3_2d->SetLabelSize(59, "xyz");
        ...
        h4_2d->GetYaxis()->SetNdivisions(5, 2, false);
        h4_2d->GetXaxis()->SetNdivisions(10, 0, false);
        h4_2d->SetTitleSize(70, "xyz");
        h4_2d->SetLabelSize(59, "xyz");
        h4_2d->SetLabelFont(43, "xyz");
        h4_2d->SetTitleFont(43, "xyz");
        h4_2d->Draw("colz");
        c1->cd(3);
        gPad->SetLogz();
        h1_2d->GetYaxis()->SetNdivisions(5, 2, false);
        h1_2d->GetXaxis()->SetNdivisions(10, 0, false);
        h1_2d->SetTitle("detector 0");
        h1_2d->SetTitleSize(70, "xyz");
        h1_2d->SetLabelSize(59, "xyz");
        ...
        h2_2d->GetYaxis()->SetNdivisions(5, 2, false);
        h2_2d->GetXaxis()->SetNdivisions(10, 0, false);
        h2_2d->SetTitleSize(70, "xyz");
        h2_2d->SetLabelSize(59, "xyz");
        ...
        h3_1d->GetXaxis()->SetNdivisions(6, 0, false);
        ...
        h4_1d->GetXaxis()->SetNdivisions(6, 0, false);
        ...
        h1_1d->GetXaxis()->SetNdivisions(6, 0, false);
        ...
        h2_1d->GetXaxis()->SetNdivisions(6, 0, false);
        ...
        h_particles_1d->SetLabelSize(59, "xyz");
