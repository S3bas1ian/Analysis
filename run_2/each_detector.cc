...
h3_1d->GetXaxis()->SetMaxDigits(1);
h3_1d->GetXaxis()->SetNdivisions(3, 2, 0);
...
h4_1d->GetXaxis()->SetMaxDigits(1);
h4_1d->GetXaxis()->SetNdivisions(3, 2, 0);
...
h1_1d->GetXaxis()->SetMaxDigits(1);
h1_1d->GetXaxis()->SetNdivisions(3, 2, 0);
...
h2_1d->GetXaxis()->SetMaxDigits(1);
h2_1d->GetXaxis()->SetNdivisions(3, 2, 0);
