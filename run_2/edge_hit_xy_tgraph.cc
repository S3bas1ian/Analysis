...
void edge_hit_xy_tgraph(std::string path, std::string particle, Double_t energy_min)
{
    ...
    mg3->GetXaxis()->SetTitleFont(43, "xyz");
    mg3->GetXaxis()->SetLabelFont(43, "xyz");
    mg3->GetXaxis()->SetTitleSize(70, "xyz");
    mg3->GetXaxis()->SetLabelSize(59, "xyz");
    mg3->GetXaxis()->SetTicks("+-");
    mg3->GetYaxis()->SetNdivisions(5,2,false);
    mg3->GetYaxis()->SetTitleFont(43, "xyz");
    mg3->GetYaxis()->SetLabelFont(43, "xyz");
    mg3->GetYaxis()->SetTitleSize(70, "xyz");
    mg3->GetYaxis()->SetLabelSize(59, "xyz");
    mg3->GetYaxis()->SetTicks("+-");
    mg3->Draw("AP");
    c1->cd(2);
    mg4->GetXaxis()->SetNdivisions(5,2,false);
    mg4->GetXaxis()->SetTitleFont(43, "xyz");
    mg4->GetXaxis()->SetLabelFont(43, "xyz");
    mg4->GetXaxis()->SetTitleSize(70, "xyz");
    mg4->GetXaxis()->SetLabelSize(59, "xyz");
    mg4->GetXaxis()->SetTicks("+-");
    mg4->GetYaxis()->SetNdivisions(5,2,false);
    mg4->GetYaxis()->SetTitleFont(43, "xyz");
    mg4->GetYaxis()->SetLabelFont(43, "xyz");
    mg4->GetYaxis()->SetTitleSize(70, "xyz");
    mg4->GetYaxis()->SetLabelSize(59, "xyz");
    mg4->GetYaxis()->SetTicks("+-");
    mg4->Draw("AP");
    c1->cd(3);
    mg1->GetXaxis()->SetNdivisions(5,2,false);
    mg1->GetXaxis()->SetTitleFont(43, "xyz");
    mg1->GetXaxis()->SetLabelFont(43, "xyz");
    mg1->GetXaxis()->SetTitleSize(70, "xyz");
    mg1->GetXaxis()->SetLabelSize(59, "xyz");
    mg1->GetXaxis()->SetTicks("+-");
    mg1->GetYaxis()->SetNdivisions(5,2,false);
    mg1->GetYaxis()->SetTitleFont(43, "xyz");
    mg1->GetYaxis()->SetLabelFont(43, "xyz");
    mg1->GetYaxis()->SetTitleSize(70, "xyz");
    mg1->GetYaxis()->SetLabelSize(59, "xyz");
    mg1->GetYaxis()->SetTicks("+-");
    mg1->Draw("AP");
    c1->cd(4);
    mg2->GetXaxis()->SetNdivisions(5,2,false);
    mg2->GetXaxis()->SetTitleFont(43, "xyz");
    mg2->GetXaxis()->SetLabelFont(43, "xyz");
    mg2->GetXaxis()->SetTitleSize(70, "xyz");
    mg2->GetXaxis()->SetLabelSize(59, "xyz");
    mg2->GetXaxis()->SetTicks("+-");
    mg2->GetYaxis()->SetNdivisions(5,2,false);
    mg2->GetYaxis()->SetTitleFont(43, "xyz");
    mg2->GetYaxis()->SetLabelFont(43, "xyz");
    mg2->GetYaxis()->SetTitleSize(70, "xyz");
    mg2->GetYaxis()->SetLabelSize(59, "xyz");
